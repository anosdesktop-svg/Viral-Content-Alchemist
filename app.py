...
st.markdown(
    ...
    /* Deep cosmic dark background with purple/blue nebula gradient */
    .stApp {
        background: linear-gradient(135deg, #0e0e0e 0%, #1a1a2e 25%, #16213e 50%, #0f0f23 75%, #0e0e0e 100%);
    ...
    /* Glassmorphism for output areas (expanders, text areas) */
    ...
    /* Additional styling for headers and subheaders */
    h3 {
        color: #00ffff;
        text-shadow: 0 0 5px #00ffff;
    }
    
    /* Ensure text areas and inputs fit the theme */
    ...
    if st.button("Generate Viral Content"):
        if not api_key.strip():
            ...
            try:
                ...
                # Store sections in session state for access in right column
...
with col2:
    # Visual Preview Placeholder or Generated Image
    st.header("Visual Preview")
    if 'generated' in st.session_state and st.session_state['generated']:
        ...
        st.markdown("Generate content first to enable visual preview.")

# Display generated content below in glassmorphism cards
