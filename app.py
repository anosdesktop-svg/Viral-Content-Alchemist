...
# Set page config for futuristic AI Studio theme
st.set_page_config(
...
# Advanced CSS Injection for Futuristic AI Studio Aesthetic
st.markdown(
    """
    <style>
    ...
    /* Glass Cards for all containers */
    .glass-card {
    ...
    /* Floating Console style for output */
    .console {
